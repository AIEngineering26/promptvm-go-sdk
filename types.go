...
// Directory not empty
var (
	conflictErrorBodyFieldStatusCode = big.NewInt(1 << 0)
	conflictErrorBodyFieldError      = big.NewInt(1 << 1)
	conflictErrorBodyFieldMessage    = big.NewInt(1 << 2)
	conflictErrorBodyFieldRequestID  = big.NewInt(1 << 3)
)
...
func (c *ConflictErrorBody) GetMessage() string {
	if c == nil {
		return ""
	}
	return c.Message
...
func (c *ConflictErrorBody) GetRequestID() *string {
	if c == nil {
		return nil
	}
	return c.RequestID
...
// SetMessage sets the Message field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *ConflictErrorBody) SetMessage(message string) {
	c.Message = message
	c.require(conflictErrorBodyFieldMessage)
}

// SetRequestID sets the RequestID field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *ConflictErrorBody) SetRequestID(requestID *string) {
	c.RequestID = requestID
	c.require(conflictErrorBodyFieldRequestID)
}
